...
/**
 * Replace the values bellow with real values to make this app functional.
 */
public class Placeholders {
    ...
    /**
     * For this tutorial, use a hardcoded asset id for one of your assets.
     */
    public static final String ASSET_ID = "__PUT_YOUR_TEST_ASSET_HERE__";
}